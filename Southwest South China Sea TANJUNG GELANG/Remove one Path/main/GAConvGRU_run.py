...
def train_and_evaluate_model():
    ...
    args = {
        ...
        'lradj': "type1",
        'checkpoints': r'D:\sea level variability\code_eio\消融实验\GAconvGRU移除path\SOFTS-main\checkpoints',
        'save_model': True,
        'device_ids': [0],
        'scale': True,
        'num_heads': 4,
    ...
    print(
        ...
        f"R2_eff={r2_batch_norm_avg:.4f}\n"
        f"Deoverlap Norm: RMSE={rmse_full_norm_avg:.3f}, "
        f"MAE={mae_full_norm_avg:.3f}, "
        f"R2_eff={r2_full_norm_avg:.4f}\n"
        f"Deoverlap Denorm: RMSE={rmse_full_denorm_avg:.3f}, "
        f"MAE={mae_full_denorm_avg:.3f}"
    )
