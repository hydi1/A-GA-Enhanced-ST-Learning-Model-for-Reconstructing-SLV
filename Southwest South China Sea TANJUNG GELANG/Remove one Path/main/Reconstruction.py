...
# 加载模型参数
state_dict = torch.load(r"D:\sea level variability\code_eio\convgru_TSVU - 反归一化\SOFTS-main\checkpoints\GAConvgru_610_seed42_GAconvgru_ssta_MS_0.0001_12_12_12_64_2_1_256\checkpoint.pth",weights_only=True)
