...
args = {
    ...
    "lradj": "type1",
    'checkpoints': r'D:\sea level variability\code_eio\convgru_TSVU - Denormalization\SOFTS-main\checkpoints',
    'save_model': True,
    'device_ids': [0],
    'scale': True,
    'num_heads': 4,
...
state_dict = torch.load(r"D:\sea level variability\code_eio\convgru_TSVU - Denormalization\SOFTS-main\checkpoints\GAConvgru_610_seed42_GAconvgru_ssta_MS_0.0001_12_12_12_64_2_1_256\checkpoint.pth",weights_only=True)
...
class CustomDataset:
    ...
    def __loda_data__(self):
        ...
        self.scaler_x = joblib.load(r'D:\sea level variability\code_eio\convgru_TSVU - Denormalization12\SOFTS-main\new_scaler_anomalies_2d.pkl')
        ...
        self.scaler_y = joblib.load(r"D:\sea level variability\code_eio\convgru_TSVU - Denormalization12\SOFTS-main\scaler_y_time.pkl")
