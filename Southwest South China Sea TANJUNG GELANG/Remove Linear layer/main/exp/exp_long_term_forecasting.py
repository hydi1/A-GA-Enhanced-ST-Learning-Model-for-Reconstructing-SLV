    ...
    def test(self, setting, test=0):
        ...
        with torch.no_grad():
            ...
            save_path_txt = os.path.join(
                r"D:\sea level variability\code_eio\消融实验\GAconvGRU移除Linear\SOFTS-main\test_result",
                'test_results.txt'
            )
