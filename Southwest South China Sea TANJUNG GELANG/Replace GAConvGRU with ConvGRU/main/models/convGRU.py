...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        self.convGRU = ConvGRU(input_size=(11, 15),
                                input_dim=4 *15,
                               hidden_dim=64,
                               kernel_size=(3, 3),
                               num_layers=1,
    ...
    def forecast(self, x_enc, x_mark_enc, x_dec, x_mark_dec):
        ...
        x_enc_conv = x_enc_conv.reshape(x_enc_conv.shape[0], 12, -1)

        enc_out1 = self.enc_embedding(x_enc_conv, x_mark_enc)
        ...
        conv_out = self.activation(pooled_out)
