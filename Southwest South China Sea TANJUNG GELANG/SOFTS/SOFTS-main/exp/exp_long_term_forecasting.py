...
class Exp_Long_Term_Forecast(Exp_Basic):
    ...
    def test(self, setting, test=0):
        ...
        with torch.no_grad():
            ...
            save_path_excel = r'D:\sea level variability\code_eio\SOFTS_TS -12\SOFTS-main\output_y48_deoverlapped.xlsx'
            ...
            save_path_txt = os.path.join(r"D:\sea level variability\code_eio\SOFTS_TS -12\SOFTS-main\test_result", 'test_results.txt')
