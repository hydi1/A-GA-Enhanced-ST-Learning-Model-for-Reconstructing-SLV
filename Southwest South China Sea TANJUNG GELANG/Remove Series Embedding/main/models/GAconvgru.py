...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        self.qconvGRU = ConvGRU(input_size=(11, 15),  # 输入特征图的高度和宽度
    ...
    def forecast(self, x_enc, x_mark_enc, x_dec, x_mark_dec):
        ...
        # print("x_enc_qconv", x_enc.shape)#([16, 12, 56, 6, 11])
        ...
        # print("x_enc_qconv", x_enc_qconv.shape)#[16, 12, 5280]
        #嵌入:将输入时间序列 x_enc 和时间标记 x_mark_enc 转换为高维表示
        #  path1
        conv_out1 = self.conv1d(x_enc_qconv)
        ...
        # path2
        conv_out2 = self.path2conv1(x_enc_qconv)  # (batch,seq_len,d_model)
