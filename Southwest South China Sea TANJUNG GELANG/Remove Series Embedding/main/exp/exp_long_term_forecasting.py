    ...
    def test(self, setting, test=0):
        ...
        with torch.no_grad():
            ...
            for i, (batch_x, batch_y, batch_x_mark, batch_y_mark) in enumerate(test_loader):
                ...
                # ===================== 新增：基于 batch（归一化）RMSE / MAE / R2_eff =====================
                # flatten -> [B*L, 1]
            ...
            full_length = total_samples + seq_len - 1  # stride=1 的滑窗常用公式
            ...
            save_path_txt = os.path.join(
                r"D:\sea level variability\code_eio\消融实验\GAconvGRU移除Series Embedding\SOFTS-main\test_result",
                'test_results.txt'
            )
