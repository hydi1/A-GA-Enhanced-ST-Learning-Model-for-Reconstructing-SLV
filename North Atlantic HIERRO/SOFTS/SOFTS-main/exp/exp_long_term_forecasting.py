    ...
    def test(self, setting, test=0):
        ...
        with torch.no_grad():
            ...
            for i, (batch_x, batch_y, batch_x_mark, batch_y_mark) in enumerate(test_loader):
                ...
                outputs_unnormalized_tensor = torch.from_numpy(outputs_unnormalized).float().reshape(-1, 6, 1)
                batch_y_unnormalized_tensor = torch.from_numpy(batch_y_unnormalized).float().reshape(-1, 6, 1)
