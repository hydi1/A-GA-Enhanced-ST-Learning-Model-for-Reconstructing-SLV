...
from models.GAconvGRUno k11 import Model
import joblib
...
args = {
    ...
    'checkpoints': r'D:\project\convgru_TSVU - Denormalization\SOFTS-main\checkpoints',
    "save_model": True,
    'device_ids': [0],
    'scale': True,
    'num_heads': 4,
...
state_dict = torch.load(r"D:\project\convgru_TSVU - Denormalization\SOFTS-main\checkpoints\TSUV5_train_SOFTS_ssta_MS_0.0001_12_12_12_64_2_1_256\checkpoint.pth",weights_only=True)
...
class CustomDataset(Dataset):
    ...
    def __loda_data__(self):
        ...
        self.scaler_x = joblib.load(r"D:\project\convgru_TSVU - Denormalization\SOFTS-main\scaler_x_time.pkl")
        self.scaler_y = joblib.load(r"D:\project\convgru_TSVU - Denormalization\SOFTS-main\scaler_y_time.pkl")
