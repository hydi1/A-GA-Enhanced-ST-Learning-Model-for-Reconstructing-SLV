...
class CustomDataset(Dataset):
    ...
    def __loda_data__(self):
        # 加载 scaler_x.pkl
        self.scaler_x = joblib.load(r"D:\project\SOFTS_TS -反归一化\SOFTS-main\scaler_x_time.pkl")
        self.scaler_y = joblib.load(r"D:\project\SOFTS_TS -反归一化\SOFTS-main\scaler_y_time.pkl")
        # 加载372个时间点的X数据
