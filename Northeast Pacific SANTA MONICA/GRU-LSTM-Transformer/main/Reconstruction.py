...
state_dict = torch.load(r"D:\sea level variability\code_nepo\GRU - 12\SOFTS-main\checkpoints\Transformerdepth41993-2023_seed200_Transformer_ssta_MS_0.0005_12_12_12_64_2_1_256\checkpoint.pth",weights_only=True)

state_dict = {k.replace('module.', ''): v for k, v in state_dict.items()}

print("模型中的参数名:", [n for n, p in model.named_parameters()])
print("Parameter names in weight file:", list(state_dict.keys()))
...
class CustomDataset(Dataset):
    ...
    def __loda_data__(self):
        ...
        self.scaler_x = joblib.load(r"D:\sea level variability\code_nepo\GRU - 12\SOFTS-main\scaler_x_time.pkl")
        self.scaler_y = joblib.load(r"D:\sea level variability\code_nepo\GRU - 12\SOFTS-main\scaler_y_time.pkl")
...
df.to_excel('reconstructed_372_timesteps_window_avg_Transformer.xlsx', index=False)
